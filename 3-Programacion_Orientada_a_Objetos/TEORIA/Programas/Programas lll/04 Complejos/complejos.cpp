...
// constructor general (Inicializa por defecto la parte real e imaginaria en "0")
...
complejo complejo::operator+ (const complejo &cmp)
{
    //complejo& suma = *this; //el puntero this es la forma que se utiliza para referirse al objeto al
                              //que se está aplicando el operador como primer operando y usamos el alias "suma".
    complejo suma;
    suma.m_real = m_real + cmp.m_real;
    suma.m_imag = m_imag + cmp.m_imag;
