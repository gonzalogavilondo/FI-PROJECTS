...
/*
    Con el objetivo de evaluar si los ejercicios relacionados con árboles AVL fueron
    resueltos correctamente, diseñar un código que le permita insertar y balancear el
    árbol, a medida que se agregan valores, así como también borrar elementos del
    mismo. Además, realizar un código de impresión del árbol de modo de visualizarlo
    tal como se lo plantea en papel.

    Nota: Use como ejemplo el ejercicio nº6 resuelto por Juan, a modo de verificar si los resultados estaban bien.
*/
int main()
{
    //Declaramos
